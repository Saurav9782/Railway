...
<body style="background-image: url(images/rail.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
  <?php 
    session_start();
    ...
    $query1=mysqli_query($conn,"SELECT * FROM user_details WHERE user_details.mobile_number=BINARY $mobile ") or die;
    $query = mysqli_query($conn,"SELECT * FROM user_details WHERE user_details.mobile_number=BINARY $mobile AND user_details.password=BINARY '".$pwd."' ") or die;
    ...
    if($row = mysqli_fetch_array($query))
    {
      ...
      ";
      $_SESSION["id"]=$temp2;
      $query3 = mysqli_query($conn," SELECT * from user_details where user_details.mobile_number=BINARY $mobile ") or die;
